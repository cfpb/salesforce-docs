...
1. This process of pull request could iterate a couple of time in order to fix defects found during the integreation tests. Please note that each time new pull request has to be generated and a new release tag with an incremental minor release number has to be generated.
